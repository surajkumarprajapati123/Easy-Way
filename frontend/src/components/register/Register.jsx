...
const Register = () => {
  ...
  const [Inputs, setInputs] = useState({ name: "", email: "", password: "", address: "", phone: "", occupation: "", about: "", imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2wNV3qaLl0Y-xPCfTz1AI56J-NPXwwZEKiA&usqp=CAU' });
